  ...
  describe '#as_models' do
    ...
    context 'with correct schema' do
      it 'generates Shale models' do
        ...
        expect(models[0].properties[0].property_name).to eq('city')
        expect(models[0].properties[0].type).to be_a(Shale::Schema::JSONCompiler::String)
        ...
        expect(models[1].properties[0].property_name).to eq('street')
        expect(models[1].properties[0].type).to be_a(Shale::Schema::JSONCompiler::String)
        ...
        expect(props[0].property_name).to eq('typeBoolean')
        expect(props[0].type).to be_a(Shale::Schema::JSONCompiler::Boolean)
        expect(props[0].collection?).to eq(false)
        expect(props[0].default).to eq(nil)

        expect(props[1].property_name).to eq('typeDate')
        expect(props[1].type).to be_a(Shale::Schema::JSONCompiler::Date)
        expect(props[1].collection?).to eq(false)
        expect(props[1].default).to eq(nil)

        expect(props[2].property_name).to eq('typeFloat')
        expect(props[2].type).to be_a(Shale::Schema::JSONCompiler::Float)
        expect(props[2].collection?).to eq(false)
        expect(props[2].default).to eq(nil)

        expect(props[3].property_name).to eq('typeInteger')
        expect(props[3].type).to be_a(Shale::Schema::JSONCompiler::Integer)
        expect(props[3].collection?).to eq(false)
        expect(props[3].default).to eq(nil)

        expect(props[4].property_name).to eq('typeString')
        expect(props[4].type).to be_a(Shale::Schema::JSONCompiler::String)
        expect(props[4].collection?).to eq(false)
        expect(props[4].default).to eq(nil)

        expect(props[5].property_name).to eq('typeTime')
        expect(props[5].type).to be_a(Shale::Schema::JSONCompiler::Time)
        expect(props[5].collection?).to eq(false)
        expect(props[5].default).to eq(nil)

        expect(props[6].property_name).to eq('typeUnknown')
        expect(props[6].type).to be_a(Shale::Schema::JSONCompiler::Value)
        expect(props[6].collection?).to eq(false)
        expect(props[6].default).to eq(nil)

        expect(props[7].property_name).to eq('typeWithDefault')
        expect(props[7].type).to be_a(Shale::Schema::JSONCompiler::String)
        expect(props[7].collection?).to eq(false)
        expect(props[7].default).to eq('"foobar"')

        expect(props[8].property_name).to eq('typeMultipleWithNull')
        expect(props[8].type).to be_a(Shale::Schema::JSONCompiler::String)
        expect(props[8].collection?).to eq(false)
        expect(props[8].default).to eq(nil)

        expect(props[9].property_name).to eq('typeMultipleWithoutNull')
        expect(props[9].type).to be_a(Shale::Schema::JSONCompiler::Value)
        expect(props[9].collection?).to eq(false)
        expect(props[9].default).to eq(nil)

        expect(props[10].property_name).to eq('typeArrayWithItems')
        expect(props[10].type).to be_a(Shale::Schema::JSONCompiler::String)
        expect(props[10].collection?).to eq(true)
        expect(props[10].default).to eq(nil)

        expect(props[11].property_name).to eq('typeArrayWithoutItems')
        expect(props[11].type).to be_a(Shale::Schema::JSONCompiler::Value)
        expect(props[11].collection?).to eq(true)
        expect(props[11].default).to eq(nil)

        expect(props[12].property_name).to eq('schemaTrue')
        expect(props[12].type).to be_a(Shale::Schema::JSONCompiler::Value)
        expect(props[12].collection?).to eq(false)
        expect(props[12].default).to eq(nil)

        expect(props[13].property_name).to eq('address')
        expect(props[13].type).to be_a(Shale::Schema::JSONCompiler::Object)
        expect(props[13].type.name).to eq('Address1')
        expect(props[13].collection?).to eq(false)
        expect(props[13].default).to eq(nil)

        expect(props[14].property_name).to eq('shipping')
        expect(props[14].type).to be_a(Shale::Schema::JSONCompiler::Object)
        expect(props[14].type.name).to eq('Address2')
        expect(props[14].collection?).to eq(false)
        expect(props[14].default).to eq(nil)

        expect(props[15].property_name).to eq('billing')
        expect(props[15].type).to be_a(Shale::Schema::JSONCompiler::Object)
        expect(props[15].type.name).to eq('Address2')
        expect(props[15].collection?).to eq(false)
        expect(props[15].default).to eq(nil)

        expect(props[16].property_name).to eq('mailing')
        expect(props[16].type).to be_a(Shale::Schema::JSONCompiler::String)
    ...
    context 'with circular dependency' do
      ...
      it 'generates Shale models' do
        ...
        expect(models[0].properties.length).to eq(1)
        expect(models[0].properties[0].property_name).to eq('a')
        ...
        expect(models[1].properties[0].property_name).to eq('a')
        expect(models[1].properties[0].type.name).to eq('A')
        expect(models[1].properties[1].property_name).to eq('b')
